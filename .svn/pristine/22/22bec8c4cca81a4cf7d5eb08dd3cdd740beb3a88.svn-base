...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    // 释放刷新的距离
    private float refreshDist = 5;
    // 释放加载的距离
    private float loadmoreDist = 5;
    ...
    Handler updateHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            Log.d("updateHandler", "updateHandler");
            // 刷新布局,会自动调用onLayout
            requestLayout();
            // 没有拖拉或者回弹完成
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        Log.d("onLayout", "PullToRefreshLayout_onLayout");
        /*if (!isLayout) {
            // 这里是第一次进来的时候做一些初始化
    ...
    {
        pullDownY = rice.ec.riceutils.Display.dip2px(getContext(), 100);
        changeState(REFRESHING);
    }
